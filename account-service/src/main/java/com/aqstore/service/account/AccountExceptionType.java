package com.aqstore.service.account;
...
public enum AccountExceptionType implements AQStoreExceptionType{
	...
	UNAUTHORIZED_ROLE("WU01","Unauthorized  to perform this operation",HttpStatus.UNAUTHORIZED),
